...
public class ArmSubsystem extends SubsystemBase {
  ...
  public ArmSubsystem() {
    m_motor = new SparkMax(Constants.Arm.kArmCanId, SparkLowLevel.MotorType.kBrushless);
    ...
    m_encoder.setPosition(Constants.Arm.kPositionFactor);
...
z
  ...
  public void runAutomatic() {
    ...
    m_controller.setReference(targetState.position, SparkMax.ControlType.kPosition, 0, feedforward);
  }
