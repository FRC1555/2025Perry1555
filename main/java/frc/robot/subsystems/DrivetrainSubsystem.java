...
public class DrivetrainSubsystem extends SubsystemBase {
  private SparkMax m_frontLeftMotor;
  private SparkMax m_frontRightMotor;
  private SparkMax m_rearLeftMotor;
  private SparkMax m_rearRightMotor;
  private SparkMaxConfig baseConfig;
  ...
  public DrivetrainSubsystem() {
    SparkMaxConfig
    m_frontLeftMotor  = new SparkMax(Constants.Drivetrain.kFrontLeftCanId, SparkLowLevel.MotorType.kBrushless);
    ...
    m_frontRightMotor = new SparkMax(Constants.Drivetrain.kFrontRightCanId, SparkLowLevel.MotorType.kBrushless);
    ...
    m_frontRightEncoder = m_frontLeftMotor.getEncoder();
    m_frontRightEncoder.setPosition(Constants.Arm.kPositionFactor);
    ...
    m_rearLeftMotor   = new SparkMax(Constants.Drivetrain.kRearLeftCanId, SparkLowLevel.MotorType.kBrushless);
    ...
    m_rearRightMotor  = new SparkMax(Constants.Drivetrain.kRearRightCanId, SparkLowLevel.MotorType.kBrushless);
